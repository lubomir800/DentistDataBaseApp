...
namespace DentistDataBaseApp.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,firstName,lastName,Age,DateOfBirth")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,firstName,lastName,Age,DateOfBirth")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
